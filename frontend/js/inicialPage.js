...
function close3() {
    ...
    box1.style.display = "block";
    helptxt.innerHTML = `Clica no icon azul escuro para ver o mapa da tua cidade, marcar locais favoritos e tirar fotos!<div class="close" onclick="close4()">Próxima</div>`
...
function close4() {
    ...
    helptxt.innerHTML = `Clica no icon azul claro para jogares um jogo<div class="close" onclick="close5()">Fechar</div>`;
